...
public class Guestbook extends BaseEntity<Category>  {
	...
	//Resolution.YEAR: yyyy Resolution.MONTH: yyyyMM Resolution.DAY: yyyyMMdd 
	//Resolution.HOUR: yyyyMMddHH Resolution.MINUTE: yyyyMMddHHmm 
	//Resolution.SECOND: yyyyMMddHHmmss Resolution.MILLISECOND: yyyyMMddHHmmssSSS 
	@NotNull
	@Field(index=Index.YES, analyze=Analyze.NO, store=Store.NO)
